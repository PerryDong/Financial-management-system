    ...
    <table>
        ...
        <tbody>
			...
			{  
				...
				$tem2=$temp->getElementsByTagName("m_manager_state")->item(0)->nodeValue;
				if(($tem==$proname)&&$tem2=="通过")
				{
			...
			?>
	               ...
	               <td><?php echo $temp->getElementsByTagName("pro_manager_state")->item(0)->nodeValue?></td>
	            	</tr>  
	           <?php }
	 	 	 }
	 	 	 if($flag==0)
